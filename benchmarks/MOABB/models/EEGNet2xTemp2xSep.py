"""
EEGNet2xTemp2xSep by Nadine El-Mufti, based on the original EEGNet from https://doi.org/10.1088/1741-2552/aace8c.
...
class EEGNet2xTemp2xSep(torch.nn.Module):
    ...
    def __init__(
        ...
        # Add conv_7 (pointwise convolution similar to conv_5)
        self.conv_module.add_module(
            "conv_7",
            sb.nnet.CNN.Conv2d(
